from gamelogic.autogame import Game
import gamelogic.agents as agents

from gamelogic.tests import RandList


list1 = [5, 2, 0, 7, 3, 0, 4, 5, 7, 4, 1, 6, 5, 3, 6, 1,
...
list2 = [1, 3, 4, 2, 5, 5, 4, 1, 0, 6, 4, 4, 3, 2, 4, 2,
...
list3 = [6, 4, 0, 7, 2, 5, 1, 7, 4, 4, 6, 5, 4, 1, 0, 7,
...
list4 = [1, 5, 4, 1, 1, 3, 2, 6, 4, 5, 3, 6, 4, 5, 7, 4,
...
list5 = [4, 6, 1, 2, 4, 3, 1, 3, 2, 3, 1, 7, 0, 1, 1, 3,
...
list6 = [0, 0, 3, 2, 6, 2, 5, 0, 6, 0, 4, 6, 0, 3, 6, 6,
...
list7 = [0, 6, 5, 1, 7, 4, 6, 5, 6, 6, 4, 7, 2, 3, 6, 1,
...
list8 = [4, 3, 6, 0, 1, 2, 7, 2, 7, 4, 7, 2, 4, 1, 7, 0,
...
list9 = [7, 2, 3, 6, 1, 4, 6, 1, 6, 5, 0, 7, 6, 6, 7, 0,
...
list10 = [3, 1, 3, 4, 6, 6, 1, 4, 0, 3, 7, 0, 6, 7, 5, 2,
...
list11 = [3, 1, 3, 4, 6, 6, 1, 4, 0, 3, 7, 0, 6, 7, 5, 2,
             4, 1, 7, 0, 7, 2, 1, 2, 7, 7, 2, 1, 7, 0, 7, 7,
             1, 0, 6, 5, 5, 7, 7, 2, 5, 3, 7, 4, 7, 6, 3, 3,
             0, 7, 0, 3, 3, 1, 4, 3, 5, 7, 4, 2, 7, 6, 3, 6,
             7, 5, 0, 3, 7, 2, 2, 2, 4, 4, 1, 7, 3, 1, 0, 4,
             ...
             5, 4, 4, 6, 5, 3, 5, 6, 3, 4, 4, 6, 6, 1, 1, 3,
             1, 6, 1, 1, 5, 5, 0, 6, 2, 2, 2, 4, 7, 5, 3, 0,
             4, 3,7,3,6,4,2,3,1,7,2,0,7,3,1,3,6,5,3,1,6,3,0,
             2,5,6,0,1,4,2,6,2,0,5,1,4,6,0,3,6,4,6,7,0,6,1,4,
             1,3,5,6,7,2,0,2,7,5,0,1,6,3,4,2,1,6,0,4,7,5,3]


def main():
    # Can specify which fruits_list to use here
    fruits_list = list1

    #specify how fast the game run
    speed = 20

    game = Game(160, 160, 20, fruits_list)
    log_file = open("autogame_log.txt", "a")

    if fruits_list == list1:
        list_id = "List 1"
    elif fruits_list == list2:
        list_id = "List 2"
    elif fruits_list == list3:
        list_id = "List 3"
    elif fruits_list == list4:
        list_id = "List 4"
    elif fruits_list == list5:
        list_id = "List 5"
    elif fruits_list == list6:
        list_id = "List 6"
    elif fruits_list == list7:
        list_id = "List 7"
    elif fruits_list == list8:
        list_id = "List 8"
    elif fruits_list == list9:
        list_id = "List 9"
    elif fruits_list == list10:
        list_id = "List 10"
    elif fruits_list == list11:
        list_id = "List 11"
    log_file.write("----" + str(list_id) + "---- \n ")

    #specfiy which agent to use here. All options are:
    #BFS, DFS, Greedy, Random, SmartRandom, BFSRand
    agent = agents.BFSRand(game.screen_width, game.screen_height, game.block_size)
    game.main_loop(agent, speed)
